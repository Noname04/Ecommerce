...
export const Navbar = () => {
  ...
  return (
    <div className="bg-white sticky top-0 dark:bg-gray-900 dark:text-white duration-200 z-40 flex py-4 px-2 justify-between items-center border-b-2 border-gray-500 dark:border-gray-300">
      {/* Drop Menu */}
      <div className="flex">
        <Dropmenu />
